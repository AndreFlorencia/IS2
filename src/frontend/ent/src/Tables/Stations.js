                    ...
                    <TableBody>
                        {data.map(station => (
                            <TableRow key={station[0]}>
                                ...
                                <TableCell>{countries.get(station[3])}</TableCell>
                                <TableCell>{timezones.get(station[4]) === "\\N" ? "Unknown" : timezones.get(station[4])}</TableCell>
                                <TableCell>{station[5] === "\\N" ? "Unknown" : station[5]}</TableCell>
                                <TableCell>{station[6] === "\\N" ? "Unknown" : station[6]}</TableCell>
                                <TableCell>{station[7]}</TableCell>
